<%@ Page Title="" Language="C#" MasterPageFile="~/Company/CompanyMaster.Master" AutoEventWireup="true" CodeBehind="ManageDepartments.aspx.cs" Inherits="EmpBackgroundVerify.Company.ManageDepartments" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <form id="form1" runat="server">
<div class="article">
          <h2><span>Manage Departments</span></h2>
                ...
                <table align="center" 
                    ...
                    <tr>
                        <td style="width: 346px" align="right">
                            <asp:TextBox ID="txtDept" runat="server" Width="300px"></asp:TextBox>
                        </td>
                        <td>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                ControlToValidate="txtDept" ErrorMessage="Cant be blank" Font-Italic="True" 
                                ForeColor="Red" ValidationGroup="a">*</asp:RequiredFieldValidator>
&nbsp;&nbsp;
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                                ControlToValidate="txtDept" ErrorMessage="Only alphabets are allowed" 
