<%@ Page Title="" Language="C#" MasterPageFile="~/Company/CompanyMaster.Master" AutoEventWireup="true" CodeBehind="SendConfirmation.aspx.cs" Inherits="EmpBackgroundVerify.Company.SendConfirmation" %>
                  ...
                  <table align="center" style="width: 70%;">
                      ...
                      <tr>
                          <td align="left" style="font-size: medium">
                              <strong style="color: #000000">Reply to confirmation request</strong></td>
                      </tr>
                      <tr>
                          <td align="right">
                              <asp:TextBox ID="txtReply" runat="server" Rows="15" TextMode="MultiLine" 
                      ...
                      <tr>
                          <td align="right">
                              <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                  ControlToValidate="txtReply" ErrorMessage="Enter text" Font-Italic="True" 
                                  ForeColor="Red" ValidationGroup="a"></asp:RequiredFieldValidator>
                          </td>
                      </tr>
                      <tr>
                          <td align="center">
                              <asp:Button ID="btnReply" runat="server" BackColor="#62B7EB" Font-Bold="True" 
                                  ForeColor="White" Text="REPLY" Width="120px" onclick="btnReply_Click" 
                                  ValidationGroup="a" />
                          </td>
                      </tr>
                  </table>
