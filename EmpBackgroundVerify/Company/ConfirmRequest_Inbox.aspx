<%@ Page Title="" Language="C#" MasterPageFile="~/Company/CompanyMaster.Master" AutoEventWireup="true" CodeBehind="ConfirmRequest_Inbox.aspx.cs" Inherits="EmpBackgroundVerify.Company.ConfirmRequest_Inbox" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <form id="form1" runat="server">
    <div class="article">
          <h2><span>Confirmation request Inbox</span></h2>
