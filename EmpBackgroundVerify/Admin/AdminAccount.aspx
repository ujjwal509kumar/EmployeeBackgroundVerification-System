<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AdminAccount.aspx.cs" Inherits="EmpBackgroundVerify.Admin.AdminAccount" %>
                    ...
                    <tr>
                        <td style="width: 346px" align="right">
                            <asp:Button ID="btnChange" runat="server" BackColor="White" Font-Bold="True" 
                                ForeColor="#33A0CB" Text="CHANGE PASSWORD" Width="300px" 
